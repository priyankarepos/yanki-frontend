...
const getTranslationKey = (index) => `personalAssistantPrompts.${index}`;

export const PersonalAssistantSlider = ({ activeTab, t, handleQuestionClick }) => {
    return (
        <Carousel
        ...
        >
            {personalAssistantPrompts.map((prompt, index) => (
...
export const PersonalAssistantMuiMobile = ({ activeTab, t, handleQuestionClick }) => {
    return (
...
export const PersonalAssistantDescription = () => {
