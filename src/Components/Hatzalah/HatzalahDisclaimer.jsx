    ...
    <>
      <Box>
        <Typography component="div" className="hatzalah-disclaimer" >
          ...
          However, the effectiveness of any medical intervention cannot be
          guaranteed. The information and resources provided by our
          organization, including but not limited to instructional videos,
          educational content, and guidance on emergency procedures, are
          intended for general information purposes only and should not be
          considered professional medical advice or a substitute for
        ...
        <Typography component="div" className="hatzalah-disclaimer">
          ...
          circumstance as individual cases may vary, and the outcomes of
        ...
        <Typography component="div" className="hatzalah-disclaimer">
          ...
          regarding a medical condition. Do not disregard, avoid, or delay
          obtaining medical advice from qualified healthcare providers based on
        ...
        <Typography component="div" className="hatzalah-disclaimer">
          ...
          accessing and using these resources, you acknowledge and agree to this
          disclaimer and assume full responsibility for the use of the
        ...
        <Typography component="div" className="hatzalah-disclaimer">
          ...
          We explicitly disclaim any warranties related to the service's
          operation, including uninterrupted or error-free service or the
        ...
        <Typography component="div" className="hatzalah-disclaimer">
          ...
          any defamatory, offensive, or illegal conduct of users or third
          parties, with all risks associated with such content resting on the
          user.
        </Typography>
        ...
        <Typography component="div" className="hatzalah-disclaimer">
          ...
          liability for certain types of damages. Accordingly, some of the above
          disclaimers, exclusions, or limitations may not apply to you, but they
